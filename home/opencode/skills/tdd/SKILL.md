---
name: tdd
description: "Use when implementing any feature or bugfix. Enforces RED-GREEN-REFACTOR cycle before any production code."
---
...
```
Over-engineered, adds features nobody asked for.
