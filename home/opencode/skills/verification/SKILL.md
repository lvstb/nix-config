---
name: verification
description: "Use before declaring any task complete, fixed, or passing. Requires running verification commands and confirming output before making any success claims."
---
...
1. Add a minimal test setup as part of the task
2. If truly impossible, document the manual verification steps performed
3. Note the verification gap in the PR/commit
...
- Commit the changes
- Move to the next task or load the code-review skill
...
- Paraphrases and synonyms ("looks good", "working now")
- Implications of success ("moving on to next task")
